package cassunshine.thework.client.rendering.items;
...
public class AlchemistNotebookRenderer {
    ...
    public static final NotebookData RENDERER_DATA = new NotebookData();
    ...
    public static void renderBook(float bookAngle, boolean useNormals, boolean drawPages, NotebookData data) {
        ...
        if (drawPages) {
...

            {
                ...
                if (data != null) {
                    var pair = data.getPages();

                    drawPage(useNormals, leftAngle, rightAngle, pair.getLeft(), pair.getRight());
                }
    ...
    private static void drawPage(boolean useNormals, float leftAngle, float rightAngle, AlchemistNotebookPage left, AlchemistNotebookPage right) {
        ...
        //Left page
        {
            ...
            if (left != null) {
                ...
                RenderingUtilities.saneVertex(0, 0, 0, 0, 1);
                RenderingUtilities.saneVertex(100, 0, 0, 1 / 3.0f, 1);
                RenderingUtilities.saneVertex(100, 100, 0, 1 / 3.0f, 0);
                RenderingUtilities.saneVertex(0, 100, 0, 0, 0);

                var renderer = AlchemistNotebookPageRenderers.getRenderer(left);
                if (renderer != null)
                    renderer.render();
            }
        ...
        //Right page
        {
            ...
            if (right != null) {
                ...
                var renderer = AlchemistNotebookPageRenderers.getRenderer(right);
                if (renderer != null)
                    renderer.render();
            }
